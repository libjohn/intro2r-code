...
> Students should do exercise_00.Rmd (preview and open in browser)
> Answers can be found in answers_00.Rmd
...
- install once
- load each time
- tour of the tidyverse loaded packages

    - Use code below to introduce the idea of categorical data
